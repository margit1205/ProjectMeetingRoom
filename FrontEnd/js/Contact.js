...
const form5 = document.getElementById('contact-form');
form5.addEventListener('submit', (e)=>{
    e.preventDefault();

    const formData5 = new FormData(form5);
  let formDataObject5 = Object.fromEntries(formData5.entries());

    
    let formDataJsonString5 = JSON.stringify(formDataObject5);


    fetch('http://localhost:8080/MeetingRoom/Message/sendMessage', {
        method:'Post', 
